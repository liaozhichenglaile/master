...
// 	{
// 	    $data=db::name('artist')->field('id,identity_front,identity_back,moka,cover_img')->select();
// 	       //dump($data);die;
// 	    foreach ($data as $k=>$v){
// 	       $map['identity_front']=str_replace('model.aihuobao.cn','cdn.mengxintonggao.cn',$v['identity_front']);
// 	       $map['identity_back']=str_replace('model.aihuobao.cn','cdn.mengxintonggao.cn',$v['identity_back']);
// 	       $map['moka']=str_replace('model.aihuobao.cn','cdn.mengxintonggao.cn',$v['moka']);
// 	       $map['cover_img']=str_replace('model.aihuobao.cn','cdn.mengxintonggao.cn',$v['cover_img']);
	            
// 	      db::name('artist')->where('id',$v['id'])->update($map);
// 	    }
